...
df_original = pd.read_csv('../annotated data.csv')
...
df_jacc_sim.to_csv('../df_jacc_sim.csv')

df_jacc = pd.read_csv('../df_jacc_sim.csv')
...
plt.savefig('../Jaccard-Similarity.png')
...
df_numwords.to_csv('../df_length.csv')

df_len = pd.read_csv('../df_length.csv')
...
plt.yticks(fontproperties = 'Times New Roman', size = 22)
plt.xticks(fontproperties = 'Times New Roman', size = 16)
plt.savefig('../paragraph-length.png')
